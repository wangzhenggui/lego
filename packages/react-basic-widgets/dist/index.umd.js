(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('react'), require('antd'), require('@ant-design/icons')) :
  typeof define === 'function' && define.amd ? define(['react', 'antd', '@ant-design/icons'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global['@apaas-lego/react-basic-widgets'] = factory(global.React, global.antd, global.icons));
}(this, (function (React, antd, icons) { 'use strict';
  ...
  var ApaasCheckBox = function ApaasCheckBox(props) {
    var _props$names = props.names,
        ...
        _props$values = props.values,
        values = _props$values === void 0 ? [] : _props$values;
    return /*#__PURE__*/React__default['default'].createElement(antd.Checkbox.Group, props, values.map(function (value, index) {
  ...
  var ApaasDatePicker = function ApaasDatePicker(props) {
    ...
    return range === 'DatePicker' ? /*#__PURE__*/React__default['default'].createElement(antd.DatePicker, props) : /*#__PURE__*/React__default['default'].createElement(antd.DatePicker.RangePicker, props);
  };
  ...
  var ApaasImageUpload = function ApaasImageUpload(props) {
    ...
    var UploadChild = function UploadChild() {
      ...
      }, fileList.length >= 8 ? null : uploadButton), /*#__PURE__*/React__default['default'].createElement(antd.Modal, {
  ...
  var ApaasModal = function ApaasModal(props) {
    ...
    return /*#__PURE__*/React__default['default'].createElement("div", {
      ...
      className: "titleName"
    }, title), /*#__PURE__*/React__default['default'].createElement(icons.CloseOutlined, null)), children ? children : /*#__PURE__*/React__default['default'].createElement("div", {
      className: "container"
      ...
      type: "default"
    }, cancelText), /*#__PURE__*/React__default['default'].createElement(antd.Button, {
      type: "primary",
      style: {
        marginLeft: '16px'
      }
  ...
  var ApaasButton = function ApaasButton(props) {
    return /*#__PURE__*/React__default['default'].createElement(antd.Button, props);
  };
